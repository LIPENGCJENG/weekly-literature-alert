...
Weekly Literature Alert 是一个通用型每周最新文献播报程序。你只需要在 GitHub 仓库中配置关键词、邮箱和 API Key，它就可以每周自动检索最新论文，筛选出值得关注的文献，并把中文或英文报告发送到邮箱。
